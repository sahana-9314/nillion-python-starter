...
async def main():
    ...
    # Create a secret named "alice_vote" with any value, ex: 500
    new_secret = nillion.NadaValues(
        {
            "alice_vote": nillion.SecretInteger(500),
        }
    )

    # Set the input party for the secret
    # The party name needs to match the party name that is storing "alice_vote" in the program
    party_name = "Party1"
    ...
    # Add bob_vote, the 2nd secret at computation time
    computation_time_secrets = nillion.NadaValues({"bob_vote": nillion.SecretInteger(10)})
